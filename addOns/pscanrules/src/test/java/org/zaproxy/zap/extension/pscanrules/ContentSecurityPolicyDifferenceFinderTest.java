...
public class ContentSecurityPolicyDifferenceFinderTest extends PassiveScannerTest<ContentSecurityPolicyDifferenceFinder> {

    @Override
    protected ContentSecurityPolicyDifferenceFinder createScanner() {
        return new ContentSecurityPolicyDifferenceFinder();
    }
    ...
    @Test
    public void shouldRaiseAlertsPreTps() throws HttpMalformedHeaderException {
        HttpMessage message = new HttpMessage();
        message.setRequestHeader("GET https://www-pre-perfumeshop.uk.aswatson.net/ HTTP/1.1");
        ...
        message.setResponseHeader(
                "HTTP/1.1 200 OK\r\n"
                        + "x-frame-options: SAMEORIGIN\r\n"
                        + "strict-transport-security: max-age=31536000;includeSubDomains\r\n"
                        + "content-security-policy:  default-src 'self' https://*.uk.aswatson.net https://*.klarnacdn.net https://*.klarna.com;  object-src 'self' blob: https://*.doubleclick.net https://*.hotjar.com https://*.bazaarvoice.com https://*.worldpay.com https://*.co-buying.com;  frame-src 'self' blob: https://*.doubleclick.net https://*.hotjar.com https://*.bazaarvoice.com https://*.worldpay.com https://*.trustarc.com https://*.facebook.com https://*.devatics.io https://*.addthis.com https://*.google.com https://*.youtube.com https://fragrance-finder.mesh.mx https://*.tradedoubler.com https://*.studentbeans.com https://*.co-buying.com https://*.rackcdn.com https://*.youtube.com https://dot.vu https://isitetv.com https://*.facebook.net https://*.eventbrite.co.uk https://*.adform.net https://lightwidget.com https://*.twitter.com https://*.constant.co https://*.gnatta.com https://*.official-coupons.com https://theperfumeshop.api.useinsider.com https://d3jdlwnuo8nsnr.cloudfront.net https://*.youthdiscount.com https://fragrancediagnostic.one.dior.com https://uk.parfumado.com https://*.parfumado.com https://parfumado.com https://*.klarna.com https://*.spotify.com https://crosswordlabs.com https://cdn.cookielaw.org;  script-src 'self' 'unsafe-inline' 'unsafe-eval' data: https://*.googleapis.com https://*.feefo.com https://*.doubleclick.net https://*.googletagmanager.com https://*.googleadservices.com https://*.peerius.com https://*.hotjar.com https://*.google-analytics.com https://*.truste.com https://*.trustarc.com https://*.facebook.net https://*.facebook.com https://*.bazaarvoice.com https://*.worldpay.com https://*.google.com https://*.devatics.io https://*.devatics.com https://*.cloudflare.com https://*.addthis.com https://*.addthisedge.com https://*.zendesk.com https://*.zdassets.com https://*.gstatic.com https://*.zopim.com https://*.aswatson.net https://*.serving-sys.com https://*.adform.net https://*.ads-twitter.com https://*.newrelic.com https://*.bing.com https://*.ascend.ai https://cdn.optimizely.com https://*.nr-data.net https://*.twitter.com https://*.co-buying.com https://*.studentbeans.com https://*.episerver.net https://*.rackcdn.com https://*.isitetv.com https://*.youtube.com https://*.ytimg.com https://*.eventbrite.co.uk https://*.goinstore.com https://*.opentok.com https://*.zencdn.net https://*.jsdelivr.net https://*.onestock-retail.io https://*.lightwidget.com https://lightwidget.com https://*.syndication.twimg.com https://*.constant.co https://*.revlifter.io https://*.official-coupons.com https://*.official-deals.co.uk https://*.gnatta.com https://*.useinsider.com https://*.contentsquare.net https://*.cloudfront.net https://s.go-mpulse.net https://*.klarnacdn.net https://cdn.cookielaw.org;  connect-src 'self' https://bam.nr-data.net https://*.googleapis.com https://*.google-analytics.com https://*.facebook.com https://*.feefo.com https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com https://*.bazaarvoice.com https://*.worldpay.com https://*.justshoutgfs.com https://*.addthis.com https://*.fragrancesoftheworld.com https://*.ovolab.com https://*.zdassets.com https://*.zendesk.com https://*.zopim.com wss://*.zopim.com https://*.serving-sys.com https://*.facebook.com https://*.twitter.com https://*.co-buying.com https://*.goinstore.com https://*.loggly.com https://*.tokbox.com https://*.opentok.com wss://*.tokbox.com https://*.episerver.net https://*.peerius.com https://*.constant.co https://*.gnatta.com https://*.revlifter.io https://*.contentsquare.net https://c.go-mpulse.net https://*.akstat.io https://*.akamaihd.net https://*.klarna.com https://*.klarnaevt.com https://cdn.cookielaw.org;  style-src 'self' 'unsafe-inline' https://*.googleapis.com https://*.google.com https://*.bazaarvoice.com https://*.worldpay.com https://*.revieve.com https://*.fontawesome.com https://*.hotjar.com https://*.devatics.io https://*.devatics.com https://*.goinstore.com https://*.zencdn.net https://*.uk.aswatson.net https://*.twitter.com;  font-src 'self' data: https://*.google.com https://*.googleapis.com https://*.gstatic.com https://*.hotjar.com https://*.theperfumeshop.com https://*.zopim.com https://*.fontawesome.com https://*.uk.aswatson.net https://*.tradedoubler.com https://*.devatics.io https://cdnjs.cloudflare.com;  img-src 'self' https: data: blob: https://*.theperfumeshop.com https://*.hotjar.com https://cdn.cookielaw.org;  media-src 'self' blob: https://*.goinstore.com https://*.theperfumeshop.com https://*.fbcdn.net;  worker-src 'self' blob: https://*.theperfumeshop.com;\r\n"
                        + "x-content-type-options: nosniff\r\n"
                        + "x-xss-protection: 1; mode=block\r\n"
                        + "content-language: uk\r\n"
                        + "content-type: text/html;charset=UTF-8\r\n"
